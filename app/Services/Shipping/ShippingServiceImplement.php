...
class ShippingServiceImplement extends ServiceApi implements ShippingService
{
     ...
     */
    protected ShippingRepository $mainRepository;

    public function __construct(ShippingRepository $mainRepository)
    {
